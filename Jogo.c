...
void gameover (){
    if (vida <= 0) {
        printf("Voce Morreu!Tente denovo");
        exit(0);
    }
}
...
int main(){
    ...
    while (1) // basicamente um loop infinito que vai ficar rolando até o player morrer
    {
        ...
        int vidainimigo = 3;
        int escolha3;
        printf("\n Enquanto trilha seu caminho, voce encontra um esqueleto, ele empunha uma cemitarra e nao parece ser amigavel \n o que voce faz?");
        while (vidainimigo >0){
            ...
            if (escolha3 == 2){
                ...
                if (classe == 1 && resultado3 == 1){
                    if (tesouro == 1){
                        ...
                        printf("Voce acerta o esqueleto com a sua espada, causando um estrago nele, contando a batalha ainda nao acabou \n");
                        vidainimigo --;
                    }
                }
                ...
                if (classe == 2 && resultado3 == 1){
                    if (tesouro == 1){
                        ...
                        printf("Voce acerta o esqueleto com a sua adaga, causando um estrago nele, contando a batalha ainda nao acabou \n");
                        vidainimigo --;
                    }
                }
                ...
                if (classe == 3 && resultado3 == 1){
                    if (tesouro == 1){
                        ...
                        printf("Voce acerta o esqueleto com uma bola de fogo, causando um estrago nele, contando a batalha ainda nao acabou \n");
                        vidainimigo --;
                    }
                }
